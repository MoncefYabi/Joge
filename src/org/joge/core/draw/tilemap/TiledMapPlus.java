...
public class TiledMapPlus extends TiledMap {
	 ...
	 */
	public TiledMapPlus(String ref) {
		this(ref, true);
	}
	 ...
	 *             Indicates a failure to load the tilemap
	 */
	public TiledMapPlus(String ref, boolean loadTileSets){
	 ...
	 *             Indicates a failure to load the tilemap
	 */
	public TiledMapPlus(InputStream in){
		super(in);
		processNameToObjectMap();
		processLayerMap();
		processTilesetMap();
	...
	public void write(OutputStream o){
		try {
			...
			transformer.transform(source, result);
                    ...
                    System.out.println("Failed to write tiledmap " + e.getMessage());
		}
	}
	 ...
	 * @throws SlickException
	 */
	public Image getVisibleTile(int x, int y){
		...
		if (visibleTileImage == null) {
			System.out.println("Tile doesn't have a tileset!");
		}
