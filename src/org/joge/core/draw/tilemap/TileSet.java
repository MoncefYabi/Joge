...
public class TileSet
{
     ...
     * @param loadImage True if the images should be loaded, false if we're
     * running somewhere images can't be loaded
    ...
    public TileSet(TiledMap map, Element element, boolean loadImage)
    {
        ...
        if ((source != null) && (!source.equals("")))
        {
            try
            {
                InputStream in = ToolKit.getResourceAsStream(map
            ...
            } catch (Exception e)
            {
                ...
                System.out.println("Unable to load or parse sourced tileset: "
        ...
        {
            System.out.println("TiledMap requires that the map be created with tilesets that use a "
...
//        }
    ...
    public void setTileSetImage(Image image)
    {
        ...
        tiles = new Image(image, tileWidth, tileHeight, tileSpacing,tileMargin);
