...
public class TiledMap
{
    ...
    public TiledMap(String ref, boolean loadTileSets)
    {
        ...
        ref = ref.replace('\\', '/');
        load(ToolKit.getResourceAsStream(ref),
    ...
    {
        load(ToolKit.getResourceAsStream(ref), tileSetsLocation);
    }
     ...
     * @see {@link #renderedLine(int, int, int)}
     */
    public void render(int x, int y, int sx, int sy, int width, int height,
    ...
    private void load(InputStream in, String tileSetsLocation)
    {
        ...
        {
            System.out.println("Failed to parse tilemap"+e.getMessage());
            e.printStackTrace();
        }
    }
